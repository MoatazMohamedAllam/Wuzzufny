...
namespace Wuzzufny.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                var roles = _context.UserRoles.ToList();
                model.Roles = roles.Take(roles.Count - 1);
        ...
        public ActionResult LogOff()
        {
            ...
            //var employeeProfile = _context.Employees.Where(e => e.Id ==userId).Single();
            //var companyProfile = _context.Companies.Where(c => c.Id ==userId).Single();
            ...
            //{
            //    ViewBag.Profile = companyProfile;
            //}
